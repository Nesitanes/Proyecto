...
<title>Pacientes Recepción | MEDICATEC</title>
...
<aside class="sidebar">
    ...
    <nav class="side-nav">
        ...
        <a href="menu_recepcion.php" class="active">Pacientes</a>
...
<header class="topbar">
    ...
    <div class="user-area">
        ...
        <span class="user-name"><?= htmlspecialchars($nombreRecepcion) ?></span>
        <span class="user-avatar"></span>
    </div>
</header>

<section class="workspace">
    <div class="page-title">Pacientes Recepción</div>
    ...
    <div class="search-row">
        ...
        <button class="future-button" type="button" data-route="Nuevos Pacientes">
            Nuevos Pacientes
        </button>
    </div>
            ...
            <table>
                ...
                <?php foreach ($pacientes as $id => $paciente): ?>
                    <tr
                        ...
                        data-patient-url="expediente.php?id=<?= $id ?>&menu=recepcion"
                        tabindex="0"
                    >
                        <td class="check-col">
                        ...
                        <td>
                            <div class="action-buttons">
                                <a
                                    class="edit-icon"
                                    href="expediente.php?id=<?= $id ?>&menu=recepcion"
